    ...
    <div class="col-md-8 col-lg-6">
        <div class="card glass-card border-0 p-5">
            <div class="gradient-header mb-4">
                ...
                <div>
                    <h3 class="mb-0">Tambah Klub</h3>
                    <small class="text-light opacity-75">Masukkan data klub sepak bola baru</small>
                </div>
            </div>
            <div class="card-body p-0">
                <form action="{{ route('klub.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama') }}" required placeholder="Contoh: Persija Jakarta">
                        @error('nama')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('tahun_berdiri') is-invalid @enderror" id="tahun_berdiri" name="tahun_berdiri" value="{{ old('tahun_berdiri') }}" placeholder="Contoh: 1928, sekitar 1900, ?">
                        @error('tahun_berdiri')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('stadion') is-invalid @enderror" id="stadion" name="stadion" value="{{ old('stadion') }}" placeholder="Contoh: Gelora Bung Karno">
                        @error('stadion')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select @error('negara_id') is-invalid @enderror" id="negara_id" name="negara_id" required>
                            ...
                            @foreach($negara as $n)
                                <option value="{{ $n->id }}" {{ old('negara_id') == $n->id ? 'selected' : '' }}>{{ $n->nama }}</option>
                            @endforeach
                        </select>
                        @error('negara_id')
                        <div class="invalid-feedback d-block">
